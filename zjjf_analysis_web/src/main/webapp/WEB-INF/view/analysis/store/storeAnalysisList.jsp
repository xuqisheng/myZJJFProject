	    ...
	    app.controller('tableController', ['$scope', 'service', function ($scope, service) {
			...
			$scope.queryOrders = function(flag){
				...
				service.getList(data).success(function (result) {
		    		...
		    		loadEchart(result.ydata.ydata, result.ydata.y1data);
	    	...
	    	var loadEchart = function(y1data, y2data) {
	          ...
	          /*  var orderOption = optionOne;
	            ...
	            orderOption.xAxis[0].data = ["1次", "2次","3次","3次以上"]
	            orderOption.series[0].name = '终端数',
	            orderOption.series[0].data = y1data;

	            cumulativeOption.legend.data = ['终端数'],
	            cumulativeOption.xAxis[0].data = ["0-5000", "5000-10000","10000-20000","20000-30000", "30000-40000","40000及以上"]
	            cumulativeOption.series[0].name = '终端数',
	            cumulativeOption.series[0].data = y2data;
