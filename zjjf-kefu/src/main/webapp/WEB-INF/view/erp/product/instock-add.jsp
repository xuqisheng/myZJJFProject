...
<script>
    $(function() {
        ...
        $('#J_dialogAddGoods').on('click', '.dialog-cancel, .dialog-close', function() {
            ...
            $('#J_dialogAddGoods').find('.checkbox:checked').each(function () {
                var data = {
            ...
            remote: {
                ...
                success: function(data) {
                    ...
                    $.each(data.list, function(i,ele) {
                        html+='<tr>';
                        html+='<td>';
                        html+='<input type="checkbox" data-id="'+ele.id+'" data-areaPrices="'+ele.areaPrice+'" data-itemBaseId="'+ele.itemBaseId+'" data-managerId="'+ele.managerId+'" class="checkbox">';
                        html+='</td>';
        ...
        function addHtml(data) {
            ...
            html+='<td>';
            if(data == null){
                html+='<input type="text" class="input itemCode" data-shortcut="enter">';
                ...
                html+='<input type="text" class="input itemCode" data-shortcut="enter" value="'+data.itemCode+'">';
                ...
                html+='</td>';
                html+='<td class="mdseIdX">'+data.mdseIdX+'</td>';
                html+='<td class="mdseId">'+data.mdseId+'</td>';
