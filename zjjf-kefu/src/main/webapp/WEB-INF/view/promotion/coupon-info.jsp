...
<div class="wrap-bd">
    <div>
        ...
        <a href="${root}/Customer/active/toIndex.do" class="crumb">活动管理</a><span class="crumb crumb-active">优惠券详情</span>
    </div>
    <div class="title mb-small">优惠券详情</div>
    <div class="wrap-bd bg">
        <div>
            <label class="label">名称：</label>
            ${spVoucherTempVo.ruleName}
        </div>
        <p>
            <label class="label">面值：</label>
            ${spVoucherTempVo.useMoney}元
        </p>
        <p>
            <label class="label">有效期：</label>
            ${spVoucherTempVo.useDay}天
        </p>
        <p>
            <label class="label">说明：</label>
            ${spVoucherTempVo.ruleRemark}
        </p>
        <p>
        ...
        <div>
            ...
            <input type="button" value="返回" class="button-cancel" id="returnBack">
        </div>
    </div>
</div>
<script>
