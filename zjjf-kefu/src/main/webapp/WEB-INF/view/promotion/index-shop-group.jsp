...
<div class="wrap-bd">
    <div class="mb-small clearfix">
        <a href="${root}/Customer/proManage/toAddCuxiao.do"><button class="button button-default fr">新建满减(关联用户组)</button></a>
    </div>
    <table class="table-list table-border"><!-- 按addTime 降序排序  -->
        ...
        <tr>
            ...
            <td>${plantRebate.ruleName}</td>
            <td><fmt:formatDate value="${plantRebate.updateTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
            <td>
    ...
    <script>
        $(function () {
            ...
            $('.J_edit').on('click', function(){
                location.href = "${root}/Customer/proManage/toEditCuxiao.do?id="+$(this).prev().val();
            });
            ...
            $('.J_status').on('click', function() {
                if($(this).text()=="开启"){
                	if(confirm("确定开启活动?")){
                		$.ajax({
        	    			type : "POST",
        	    			url : "${root}/Customer/proManage/startOrStopCuxiao.do",
        	    			async : false,
