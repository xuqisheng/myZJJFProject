...
<head>
  ...
  <script type="text/javascript">
  	...
  	var zuoBiao = {"x":"114.066112","y":"22.548515"};
    ...
    function addMapOverlay(){
      var markers = [];
      $.post("${root}/customer/appStore/getTempMap.do",function(data){
	  		if(data.success){
	  			markers=JSON.parse(data.message);
	  			console.log(typeof markers);
	  			for(var index = 0; index < markers.length; index++ ){
	  		        var point = new BMap.Point(markers[index].position.lng,markers[index].position.lat);
	  		        var marker = new BMap.Marker(point,{icon:new BMap.Icon("http://www.izjjf.cn/group1/M00/03/AE/cEpChle8JH-ActfTAAAG6n1IvaI065.png",new BMap.Size(16,31),{
