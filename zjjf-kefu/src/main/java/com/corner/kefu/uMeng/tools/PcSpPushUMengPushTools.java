package com.corner.kefu.uMeng.tools;
...
public class PcSpPushUMengPushTools {
	private String appkey_Android = "55c1668967e58e57b40018bb";
	private String appMasterSecret_Android = "vvny1sz1cevlvo2raceztpdix85zqm4h";
	private String timestamp = Integer.toString((int) (System.currentTimeMillis() / 1000));
	private String appkey_IOS = "55f7d14be0f55a4b140040a5";
	private String appMasterSecret_IOS = "crybc6ooxzhutqie0wtp1vejhnccudof";
	private String appkey_IOS2 = "563ac892e0f55a995d0022d9";
	private String appMasterSecret_IOS2 = "di6awn6dx3wx9l7wujcyvo2h70qebace";
	
	private static PcSpPushUMengPushTools instance;

	public String getTimeStamp(){
		return Integer.toString((int) (System.currentTimeMillis() / 1000));
	}
	// 同步方法，以免单例多线程环境下出现异常
	public synchronized static PcSpPushUMengPushTools getInstance() {
		if (instance == null) {
			instance = new PcSpPushUMengPushTools();
		}
		return instance;
	}
	...
	//appstore版
	public void sendIOSCustomizedcast2(UMengMessageVo uMengMessageVo) throws Exception {
		IOSCustomizedcast customizedcast = new IOSCustomizedcast();
		customizedcast.setAppMasterSecret(appMasterSecret_IOS2);
		customizedcast.setPredefinedKeyValue("appkey", this.appkey_IOS2);
		customizedcast.setPredefinedKeyValue("timestamp",getTimeStamp());
		customizedcast.setPredefinedKeyValue("alias", uMengMessageVo.getAlias());
		customizedcast.setPredefinedKeyValue("alias_type", uMengMessageVo.getAlias_type());
		customizedcast.setPredefinedKeyValue("alert", uMengMessageVo.getAlert());
	...
	public void sendIOSUnicast() throws Exception {
		...
		unicast.setPredefinedKeyValue("device_tokens", "8dc732abe37ac10a383402630a4dd1dc06aea35ad535b965b59bcd1c00d695f2");
	...
	//appStore版ios
	public void sendIOSBroadcast2(UMengMessageVo uMengMessageVo) throws Exception {
		IOSBroadcast broadcast = new IOSBroadcast();
		broadcast.setAppMasterSecret(appMasterSecret_IOS2);
		broadcast.setPredefinedKeyValue("appkey", this.appkey_IOS2);
		broadcast.setPredefinedKeyValue("timestamp", getTimeStamp());
	...
	public static void main(String[] args) {
		...
		PcSpPushUMengPushTools demo = PcSpPushUMengPushTools.getInstance();
		try {
...
*/			
			UMengMessageVo uMengMessageVo2 = new UMengMessageVo();
			/*uMengMessageVo2.setAlias("13428693333");
			uMengMessageVo2.setAlias_type("android");*/
			uMengMessageVo2.setAlias("18033080002");
			uMengMessageVo2.setAlias_type("iOS");
			/*uMengMessageVo2.setAlias("100");
			uMengMessageVo2.setAlias_type("spGroupId");*/
			/*uMengMessageVo2.setAlias("1");
			uMengMessageVo2.setAlias_type("spGroupId");*/
			uMengMessageVo2.setTicker("好消息");
			uMengMessageVo2.setTitle("好消息");
			uMengMessageVo2.setText("helLo 你好");
			uMengMessageVo2.setAlert("hello,你好");
			//demo.sendAndroidCustomizedcast(uMengMessageVo2);
			demo.sendIOSCustomizedcast(uMengMessageVo2);
			//demo.sendIOSUnicast();
