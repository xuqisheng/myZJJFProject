...
/**
 * 
* @ClassName: Dom4jXmlUtil
* @Description: TODO(Dom4j读写xml )
* @author luke
* @email   luke@mibodoctor.com  
* @date 2015年4月16日 下午2:03:14
*
 */
public class Dom4jXmlUtil {  
    ...
    public static void read1() {  
        try {  
            ...
            InputStream in = Dom4jXmlUtil.class.getClassLoader().getResourceAsStream("test.xml");  
