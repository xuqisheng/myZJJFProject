...
/** 
 *  
* @ClassName: SAXXmlUtil
* @Description: TODO(SAX API 操作 xml )
* @author luke
* @email   luke@mibodoctor.com  
* @date 2015年4月16日 下午2:00:01
*
 */
public class SAXXmlUtil {  
    ...
    public static void read() {  
        try {  
            ...
            InputStream in = SAXXmlUtil.class.getClassLoader().getResourceAsStream("test.xml");  
