...
public class ERPMarketStockInfo {
    private String id;
    ...
    public Boolean getIsSaleBack() {
        return isSaleBack;
    }

    public void setIsSaleBack(Boolean isSaleBack) {
        this.isSaleBack = isSaleBack;
    }
}