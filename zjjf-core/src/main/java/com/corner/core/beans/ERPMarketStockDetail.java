...
public class ERPMarketStockDetail {
    private String id;
    ...
    private Short operateQuantityBack;
    ...
    public Short getOperateQuantityBack() {
        return operateQuantityBack;
    }

    public void setOperateQuantityBack(Short operateQuantityBack) {
        this.operateQuantityBack = operateQuantityBack;
    }
