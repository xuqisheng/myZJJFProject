...
public class SpOrderDetail implements Serializable{
    ...
    public String getGiftSpId() {
        return giftSpId;
    }

    public void setGiftSpId(String giftSpId) {
        this.giftSpId = giftSpId == null ? null : giftSpId.trim();
    }
}