...
public class AccessTokenService {
	...
	public String getWXToken(){
		String token = cacheService.getWXTokenFromCache();
		if(StringUtils.isEmpty(token)){
			...
			try {
				...
				if(StringUtils.isEmpty(getToken)){
					...
					cacheService.putWXTokenToCache(getToken);
					return getToken;
				}
			} catch (Exception e) {	
				e.printStackTrace();
	...
	public String getWXTicket(){
		String ticket = cacheService.getWXTicketFromCache();
			...
			if(StringUtils.isEmpty(token)){
				...
				try {
					...
					if(StringUtils.isEmpty(getTicket)){
						...
						cacheService.putWXTicketToCache(getTicket);
						return getTicket;
					}
				} catch (Exception e) {
					e.printStackTrace();
