...
public class AlipayConfig extends PayConfig{
	...
	public static String partner = "2088511429822202";
	// 商户的淘宝账号
	public static String seller_email = "zhuanjiaojiefang@163.com";
	// 商户的私钥
	public static String key = "n2by9zvvps8bmone1h67vatgqa59sl21";
	//默认支付方式
