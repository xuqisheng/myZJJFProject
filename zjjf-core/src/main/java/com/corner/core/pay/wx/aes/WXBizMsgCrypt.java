 ...
 */
package com.corner.core.pay.wx.aes;
...
public class WXBizMsgCrypt {
	...
	/**
	 * 对明文进行加密.
	 * 1.AES_Encrypt [random(16B)+ msg_len(4B) + msg + $AppId])
	 * AESKey =Base64_Decode(EncodingAESKey + “=”),32个字节
	 * 2.Base64_Encode(AES_Encrypt [random(16B)+ msg_len(4B) + msg + $AppId])
	 * 3.msg_signature=sha1(sort(Token、timestamp、nonce, msg_encrypt))
	 * 4.timestamp、nonce回填请求中的值或者重新生成均可
	 * 
	 * @param text 需要加密的明文
