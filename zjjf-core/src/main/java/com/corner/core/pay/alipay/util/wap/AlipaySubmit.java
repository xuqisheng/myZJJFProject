package com.corner.core.pay.alipay.util.wap;
...
import com.corner.core.pay.alipay.config.AlipayConfigForWAP;
import com.corner.core.pay.alipay.config.AlipayErrorConfig;
...
import com.corner.core.pay.alipay.sign.RSA;
...
public class AlipaySubmit {
    ...
    public static String buildRequest(String ALIPAY_GATEWAY_NEW, String strParaFileName, String strFilePath,Map<String, String> sParaTemp) throws Exception {
        ...
        if (response == null) {
        	logger.info("buildRequest  response is null");
            return null;
        }
    ...
    public static String getRequestToken(String text) throws Exception {
    	...
    	}else if(paraText.get("res_error") != null ) {
    		logger.error(paraText.get("res_error"));
    		logger.error( "获取TOKEN请求失败，失败原因："+AlipayErrorConfig.ERROR_CREATE_TOKEN+", 支付宝报文:" + paraText);
    	}
	...
	public static String query_timestamp() throws MalformedURLException,
        ...
        String strUrl = "https://mapi.alipay.com/gateway.do?service=query_timestamp&partner=" + AlipayConfigForWAP.partner;
