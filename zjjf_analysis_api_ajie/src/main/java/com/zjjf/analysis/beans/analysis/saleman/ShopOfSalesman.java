...
public class ShopOfSalesman {
    ...
    public void setIsMultipleShop(String isMultipleShop) {
        this.isMultipleShop = isMultipleShop == null ? null : isMultipleShop.trim();
    }
    ...
    public void setSaleRatio(String saleRatio) {
        this.saleRatio = saleRatio == null ? null : saleRatio.trim();
    }
    ...
    public void setBaccyLicence(String baccyLicence) {
        this.baccyLicence = baccyLicence == null ? null : baccyLicence.trim();
    }
