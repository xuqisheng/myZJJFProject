...
@Controller
public class HomeController extends APCBaseWebController {
	
	private static Logger logger = LoggerFactory.getLogger(HomeController.class);
	
	@RequestMapping(value = "/gotoManageHome.do", method = RequestMethod.GET)
	public String gotoManageHome(HttpServletRequest request, HttpServletResponse response, Model model) throws IOException {
		return "index";
	}
