...
public class BeanUtil {
    ...
    * @author 孟星魂	mengxinghun@izjjf.cn
     ...
     * @since 1.0.0
     */
    public static <E extends Serializable> E toObject(Class<E> clazz, Map<String, Object> fromMap) {
     ...
     * @since 1.0.0 
     */
    public static <E extends Serializable> E toObject(Class<E> clazz, Object obj) {
     ...
     * @since 1.0.0 
     */
    public static <E extends Serializable> List<E> toObject(Class<E> clazz, List<?> objList) {
