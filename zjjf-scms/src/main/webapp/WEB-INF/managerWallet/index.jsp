...
<div class="wrap-bd">
	<div class="wallet-center">
	    <div class="wallet-center-title">
	        <h2>钱包中心</h2>
	        <a href="${root}/scms/manager/toMaWalletLog.do" class="color-a">收支明细</a>
	    </div>
	    <div class="wallet-center-content">
	        ...
	        <div>
	            ...
	            <a href="${root}/scms/manager/toMaWithDraw.do" class="color-a"><button class="wallet-button">提现</button></a>
	        </div>
	    </div>
	</div>
	<div class="title mt-default mb-small">提现记录</div>
	<div class="op-section mt-small">
		<form action="${root}/scms/manager/toWallet.do" name="frm_query" method="post" id="test" >
			<label>起止日期：</label>
            ...
            <tbody class="table-tbody">
            	<c:forEach items="${list}" var="log">
            		<tr>
						...
						<td><a href="${root}/scms/manager/toMaWithDrawById.do?id=${log.id}">查看</a></td>
            		</tr>
            	</c:forEach>
...
<script>
	$(function() {
		...
		$("#thisDay").click(function(e){
			location.href='${root}/scms/manager/toWallet.do?findType=1';
		});
		
		$("#thisMonth").click(function(e){
			location.href='${root}/scms/manager/toWallet.do?findType=2';
		});
