	...
	<div class="wallet-withdraw-handle">
		...
		<div class="handle-item handle-item-active">
			<div class="handle-item-border">
				...
				<!-- 2015-09-17 15:50 -->
				<fmt:formatDate value="${maWithDraw.applyTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
			</div>
		</div>
		<div class="handle-item handle-item-active">
			<div class="handle-item-border">
				...
				<!-- 2015-09-17 15:50 -->
				<fmt:formatDate value="${maWithDraw.checkTime}" pattern="yyyy-MM-dd HH:mm:ss"/><!--提现成功,时间读取的是审核时间字段  -->
			</div>
		</div>
		<div class="handle-item handle-item-active">
			<div class="handle-item-border-transparent">
				...
				<!-- 2015-09-20 24:00 前 -->
				<fmt:formatDate value="${maWithDraw.payTime}" pattern="yyyy-MM-dd HH:mm:ss"/><!--提现成功,时间读取的是支付时间  -->
			</div>
		</div>
	</div>
