...
<div class="wrap-bd">
    <div class="mb-small">
        ...
        <a href="${root}/scms/wh/toWhWalletIndex.do" class="crumb">我的钱包</a><span class="crumb crumb-active">提现状态</span>
    </div>
	...
	<div class="wallet-withdraw-handle">
		...
		<div class="handle-item handle-item-active">
			<div class="handle-item-border">
				...
				<!-- 2015-09-17 15:50 -->
				<fmt:formatDate value="${whWithDraw.applyTime}" pattern="yyyy-MM-dd HH:mm"/>
			</div>
		</div>
		<div class="handle-item handle-item-active">
			<div class="handle-item-border">
				...
				<!-- 2015-09-17 15:50 -->
				<fmt:formatDate value="${whWithDraw.checkTime}" pattern="yyyy-MM-dd HH:mm"/><!--提现成功,时间读取的是审核时间字段  -->
			</div>
		</div>
	...
	<table class="table-list">
		...
		<tr>
			...
			<td>
				普通提现<br />
				流水号 ${whWithDraw.bankDealNo}
			</td>
			<td class="wallet-money color-red">${whWithDraw.amount}</td>
		</tr>
		</tbody>
	</table>
	<br />
	<table class="table-list table-list-border">
		<tbody class="table-tbody">
			<tr>
				<td>提现信息：</td>
				<td>${scmsWarehouse.cardUser}（${scmsWarehouse.bankName}：${scmsWarehouse.bankNum}）</td>
			</tr>
			<tr>
				<td>时间报告：</td>
			...
			<tr>
				<td>&nbsp;</td>
				<td><fmt:formatDate value="${whWithDraw.applyTime}" pattern="yyyy-MM-dd HH:mm"/></td>
			</tr>
		</tbody>
	</table>
</div>
