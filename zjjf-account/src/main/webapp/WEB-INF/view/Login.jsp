...
#centerbgdiv{ position: absolute;top:75px; height:528px; background: #FFC586; width: 100%;z-index: -10000}
#formWap{position: absolute; width: 320px; height: 200px;top:240px; right:520px; }
#submitBt{ font-size:16px; font-weight:bord; color:white; display:block; height:43px;line-height:43px; width:308px; text-align:center; bolder;background:url(<c:url value='/resources/images/loginbt.png'/>) 0 0  no-repeat; margin: 0 auto;}
.submitBtdw{background:url(<c:url value='/resources/images/loginbt2.png'/>) 0 0  no-repeat;}
...
$(function() {
	...
	$("#submitBt").click(function(){
		...
		$(this).css("background","url(<c:url value='/resources/images/loginbt2.png'/>) 0 0  no-repeat");
	}).mouseup(function(){
		$(this).css("background","url(<c:url value='/resources/images/loginbt.png'/>) 0 0  no-repeat");
	});
...
<div id="adminlog-centerbg">
	    ...
	    <div style="width: 1920px; height: 604px; overflow: hidden;margin:0 auto;background:url(<c:url value='/resources/images/adminlog.png'/>) center center no-repeat; position: relative;">
	    	<div id="formWap">
