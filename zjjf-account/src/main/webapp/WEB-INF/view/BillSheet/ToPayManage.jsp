...
<div class="easyui-layout"  fit="true" id="toPayOrderListMgdgLayout">
	<div region="center">
		<!--=================================================west-table========================================================  -->
		<table id="toPayOrderListMgdg" idField="id"  sortName="ackTime" sortOrder="desc"  pageSize="50"
...
var mibocrud = MiBoCRUD.creatNew({
	...
	dialogTitle:"用户信息编辑",
	queryParams:{'supplierId':'${supplierId}','acStatus':'${acStatus}'},
	...
	findListFun:function(){
		$("#toPayOrderListMgdg" ).datagrid('load',{
			areaId:$("#toPayOrderListMgField1").combobox('getValue'),
