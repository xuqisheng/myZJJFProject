				...
				<table cellpadding="5">
					<tr>
						...
						<td><input class="easyui-textbox" type="text" name="name" value="${Model.name}" 
								style="width: 180px" data-options="required:true"></input></td>
					</tr>
					<tr>
						<td>内容：</td>
						<td><input class="easyui-textbox" name="content" data-options="multiline:true" 
								style="width: 180px; height: 60px" value="${Model.content}"></input></td>
					</tr>
					<tr>
						<td>排序：</td>
					...
					<tr>
						...
						<td>
							<textarea name="remark" data-options="multiline:true" maxlength="50"
								style="width:180px; height:60px">${Model.remark}</textarea>
						</td>
					</tr> -->
				</table>
			</form>
...
<script type="text/javascript">
	$(function() {
		$('#ff').form({
			url : root + "/admin/healthplanctl/EditItem.do?",
			onSubmit : function() {
