...
<body class="easyui-layout">
	<div region="center" style="padding:0px;" border="false" header="false">  
	    <table border="false" fit="true" id="tt" class="easyui-datagrid" 
	    		url="${root}/admin/sysmonitorctl/PushMessageList.do" nowrap="false"
	        ...
	        <thead>
	            <tr>
	                ...
	                <th field="publishName" width="50" sortable="true">发送人</th>
	                <th field="publishPhoneNum" width="50" sortable="true">发送人号码</th>
	                <th field="receiveName" width="50" sortable="true">接收人</th>
	                <th field="receivePhoneNum" width="50" sortable="true">接收人号码</th>
	                <th field="msgType" width="80" sortable="true" formatter="formatMsgType">短信发送类型</th>
	                <th field="data" width="200" sortable="true" formatter="formatData">内容</th>
	                <th field="dataType" width="50" sortable="true" formatter="formatDataType">消息类型</th>
	                <th field="state" width="50" sortable="true" formatter="formatState">发送状态</th>
	                <th field="createTime" width="60" sortable="true">推送时间</th>
	            </tr>
	        </thead>
	    </table>
	    <div id="tb" style="padding:2px 5px;">
	    	<div style="margin-top: 2px;">
	    		...
	    		接收人:<input id="receiveName"class="easyui-textbox" style="width:140px;">
	    		信息状态: 
...
<script type="text/javascript">
	...
	function pushMsgFind(){
		$('#tt').edatagrid('load',{
			...
			receiveName: $("#receiveName").textbox('getValue'),
	...
	function formatData(val, row){
		return '<a href="#" mce_href="#" onclick="viewData(\''
				+ row.dataType + '\',\'' + val + '\')">' + val + '</a>';
	}
	
	// 查看消息内容
	function viewData(type, val){
		if(type == 0){
			alert("只能查看订单");
			return;
		}
		var url = root + "/admin/orderInfoctl/ViewOrder.do?orderId="+val;
		showWindow("订单详情", url, 520, 360, pushMsgFind);
	}
