...
public class Mail {   
    ...
    public static void main(String[] args){  
        ...
        String from = "mudaoren@izjjf.cn";  
        String to = "suying@izjjf.cn";  
        String copyto = "mudaoren@izjjf.cn";  
        String subject = "批处理异常";  
        String content = "邮件内容——>批处理异常";  
        String username="mudaoren@izjjf.cn";  
        String password="--Xzl4711";  
        String filename = "";  
