...
public class AppPage<T> implements Serializable {
	 ...
	 */
	public AppPage(HttpServletRequest request, HttpServletResponse response){
	 ...
	 */
	public AppPage(HttpServletRequest request, HttpServletResponse response, int defaultPageSize){
	 ...
	 * @param pageSize 分页大小
	 */
	public AppPage(int pageNo, int pageSize) {
	 ...
	 * @param count 数据条数
	 */
	public AppPage(int pageNo, int pageSize, long count) {
	 ...
	 * @param list 本页数据对象列表
	 */
	public AppPage(int pageNo, int pageSize, long count, List<T> list) {
		this.setCount(count);
...
//	}
	 ...
	 * @param list
	 */
	public AppPage<T> setList(List<T> list) {
		this.list = list;
		initialize();
		return this;
	}
