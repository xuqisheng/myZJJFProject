...
<head>
    ...
    <title>转角阿街后台系统 </title>
    <meta name="decorator" content="defualt"/>

    <meta name="keywords" content="阿街后台系统,转角阿街后台系统">
    <meta name="description" content="阿街后台系统是支撑转角街坊业务员app应用的管理维护系统。">

    <!--[if lt IE 9]>
    <meta http-equiv="refresh" content="0;ie.html" />
    <![endif]-->
	<link href="${ctxStatic}/bootstrap/3.3.6/css/bootstrap.min14ed.css?v=3.3.6" rel="stylesheet">
	<link href="${ctxStatic}/bootstrap/3.3.6/css/font-awesome.min93e3.css?v=4.4.0" rel="stylesheet">
	<link href="${ctxStatic}/bootstrap/3.3.6/css/animate.min.css" rel="stylesheet">
	<link href="${ctxStatic}/bootstrap/3.3.6/css/style.min862f.css?v=4.1.0" rel="stylesheet">
	
	<script src="${ctxStatic}/plugins/jquery/jquery.min.js?v=2.1.4" type="text/javascript"></script>
	<script src="${ctxStatic}/bootstrap/3.3.6/js/bootstrap.min.js?v=3.3.6" type="text/javascript"></script>
	<script src="${ctxStatic}/plugins/metisMenu/jquery.metisMenu.js" type="text/javascript"></script>
	<script src="${ctxStatic}/plugins/slimscroll/jquery.slimscroll.min.js" type="text/javascript"></script>
<%--     <script src="${ctxStatic}/plugins/layer/layer.min.js" type="text/javascript"></script> --%>
    <script src="${ctxStatic}/plugins/layer/layer.js" type="text/javascript"></script>
	<script src="${ctxStatic}/common/hplus.min.js?v=4.1.0" type="text/javascript"></script>
	<script src="${ctxStatic}/common/contabs.min.js" type="text/javascript"></script>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="http://exmail.qq.com/cgi-bin/loginpage?t=dm_loginpage&dmtype=bizmail&s=session_timeout">收件箱</a>
                            </li>
                            <li><a class="J_menuItem" href="http://exmail.qq.com/cgi-bin/loginpage?t=dm_loginpage&dmtype=bizmail&s=session_timeout">查看邮件</a>
                            </li>
                            <li><a class="J_menuItem" href="http://exmail.qq.com/cgi-bin/loginpage?t=dm_loginpage&dmtype=bizmail&s=session_timeout">写信</a>
                            </li>
                        </ul>
                    </li>
                    <!-- <li>
						...
						<c:if test="${menu.parent.id eq '1'&&menu.isShow eq '1'}">
					      <li>
							<c:if test="${empty menu.href}">
								<a href="#"><i class="fa fa-cutlery"></i> <span class="nav-label">${menu.name}</span><span class="fa arrow"></span></a>
							</c:if>
							<c:if test="${not empty menu.href}">
								<a class="J_menuItem" href="${fn:indexOf(menu.href, '://') eq -1 ? ctx : ''}${menu.href}" data-id="${menu.id}">
					              	...
					              	<c:forEach items="${menuList}" var="menu2">
					              	  <c:if test="${menu2.parent.id eq menu.id&&menu2.isShow eq '1'}">
											...
											<c:if test="${empty menu2.href}">
												<a href="#"><i class="fa fa-cutlery"></i> <span class="nav-label">${menu2.name}</span><span class="fa arrow"></span></a>
											</c:if>
											<c:if test="${not empty menu2.href}">
												<a class="J_menuItem" href="${fn:indexOf(menu2.href, '://') eq -1 ? ctx : ''}${not empty menu2.href ? menu2.href : '/404'}" data-id="${menu2.id}">
								              	...
								              	<c:forEach items="${menuList}" var="menu3">
								              	  <c:if test="${menu3.parent.id eq menu2.id&&menu3.isShow eq '1'}">
														...
														<c:if test="${empty menu3.href}">
															<a href="#"><i class="fa fa-cutlery"></i> <span class="nav-label">${menu3.name}</span><span class="fa arrow"></span></a>
														</c:if>
														<c:if test="${not empty menu3.href}">
															<a class="J_menuItem" href="${fn:indexOf(menu3.href, '://') eq -1 ? ctx : ''}${not empty menu3.href ? menu3.href : '/404'}" data-id="${menu3.id}">
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    <div class="navbar-header"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                        <form role="search" class="navbar-form-custom" method="post" action="http://www.izjjf.cn">
...
<!--                 <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="index_v148b2.html?v=4.0" frameborder="0" data-id="index_v1.html" seamless></iframe> -->
            ...
            <div class="footer">
                <div class="pull-right">&copy; 2016-2099 <a href="http://www.izjjf.cn/" target="_blank">转角街坊</a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
