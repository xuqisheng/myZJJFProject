...
import com.corner.salesman.common.utils.CookieUtils;
...
public class Page<T> {
	...
	public String toString() {
		...
		sb.append("<li class=\"disabled\"><a style=\"height: 28px;\" href=\"javascript:\">当前 ");
		sb.append("<input type=\"text\" style=\"width:40px;height: 18px;line-height:5px;\" value=\""+pageNo+"\" onkeypress=\"var e=window.event||this;var c=e.keyCode||e.which;if(c==13)");
		sb.append(funcName+"(this.value,"+pageSize+",'"+funcParam+"');\" onclick=\"this.select();\"/> / ");
		sb.append("<input type=\"text\" style=\"width:40px;height: 18px;line-height:5px;\" value=\""+pageSize+"\" onkeypress=\"var e=window.event||this;var c=e.keyCode||e.which;if(c==13)");
		sb.append(funcName+"("+pageNo+",this.value,'"+funcParam+"');\" onclick=\"this.select();\"/> 条，");
		sb.append("共 " + count + " 条"+(message!=null?message:"")+"</a></li>\n");

		sb.insert(0,"<ul style=\"margin-top:-10px;\" class=\"pagination\">\n").append("</ul>\n");
