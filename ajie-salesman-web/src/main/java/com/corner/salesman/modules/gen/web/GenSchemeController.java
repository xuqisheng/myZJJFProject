 ...
 */
package com.corner.salesman.modules.gen.web;
...
import com.corner.salesman.modules.gen.service.GenSchemeService;
import com.corner.salesman.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String list(GenScheme genScheme, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        if(!genSchemeService.checkSrcPathConfig()){
			addMessage(model, "您未配置源码路径“srcPath”或您配置的路径不正确，只有正确配置后才能生成源码！</br>"
					+ "请在“salesman-web.properties”中配置正确的“srcPath”。</br>"
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.corner.salesman.modules");
		}
