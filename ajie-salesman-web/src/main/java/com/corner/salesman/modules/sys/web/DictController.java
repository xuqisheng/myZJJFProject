...
import com.corner.salesman.modules.sys.service.DictService;
...
public class DictController extends BaseController {
	...
	@ResponseBody
	public Object updateDelFlag(Dict dict, Model model) {
		Json json = new Json();
		try{
			dictService.updateDelFlag(dict);
			json.setSuccess(true);
			json.setMsg("修改数据字典数据删除状态成功！");
		}catch(Exception e){
			json.setSuccess(false);
			json.setMsg("修改数据字典数据删除状态异常！");
			json.setCode("500");
		}
		return json;
	}
