    ...
    <div class="total-c clearfix">
        <div class="total">
            <div class="total-top">
                ...
                <div class="h2">{{bannerData.todayAddReg}}</div>
                <div>今日新增</div>
            </div>
            <div class="div">
                <div class="div-item">
                    <b>{{bannerData.yestodayAddReg}}</b>
                    <br>昨日新增
                </div>
                <div class="div-item">
                    <b>{{bannerData.monthReg}}</b>
                    <br>本月新增
                </div>
            </div>
        </div>
        <div class="total">
            <div class="total-top">
                ...
                <div class="h2">{{bannerData.todayAddActive}}</div>
                <div>今日新增</div>
            </div>
            <div class="div">
                <div class="div-item">
                    <b>{{bannerData.yesTodayAddActive}}</b>
                    <br>昨日新增
                </div>
                <div class="div-item">
                    <b>{{bannerData.monthAddActive}}</b>
                    <br>本月新增
                </div>
            </div>
        </div>
        <div class="total">
            ...
            <div class="div">
                <div class="div-item mt-default">
                    <div class="h2">{{bannerData.unorderStore}}</div>
                    <br>未下单终端
                </div>
                <div class="div-item mt-default">
                    <div class="h2">{{bannerData.totalStore}}</div>
                    <br>终端总数
                </div>
            </div>
        </div>
