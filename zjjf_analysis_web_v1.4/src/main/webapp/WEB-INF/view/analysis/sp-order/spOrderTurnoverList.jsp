...
<input type="hidden" name="menuId" class="input input-default" value=${menuId } id="menuId">
	...
	<div class="total-c clearfix">
	    <div class="total">
	        <div class="total-top"><%--class="title"--%>
	            <div class="SummaryDataShow-BlueTitle ta-l">日交易额汇总</div>
	            <div class="h2">{{dailyMummary.todayTurnoverSum}}</div>
                <div>今日交易额</div>
	        </div>
	       <%-- <div class="cont">--%>
            <div class="div">
                <div class="div-item">
                    <b>{{dailyMummary.yesTodayTurnoverSum}}</b>
                    <br>昨日交易额
                </div>
                <div class="div-item">
                    <b ng-class="{true: 'txt-success', false: 'txt-warn'}[dailyMummary.dailyIncrease >= 0]">{{dailyMummary.dailyIncrease}}%</b>
                    <br>日增长率
                </div>
            </div>
	        <%--</div>--%>
	    ...
	    <div class="total">
            <div class="total-top"><%--class="title"--%>
	            ...
	            <div class="h2">{{monthMummary.thisMonthTurnoverSum}}</div>
                <div>本月交易额</div>
	        </div>
	        <%--<div class="cont">--%>
	            <div class="div">
	                <div class="div-item">
	                    <b>{{monthMummary.lastMonthTurnoverSum}}</b>
	                    <br>上月交易额
	                </div>
	                <div class="div-item">
	                    <b ng-class="{true: 'txt-success', false: 'txt-warn'}[monthMummary.monthIncrease >= 0]">{{monthMummary.monthIncrease}}%</b>
	                    <br>月增长率
	                </div>
	            </div>
	        <%--</div>--%>
	        ...
	        <tbody class="table-tbody">
	       		<tr ng-repeat="d_row in key_dataList">
		       		<td ng-repeat="b in d_row track by $index">
		       			<b ng-if="$index == '6' || $index == '9'" ng-class="{true: 'txt-success', false: 'txt-warn'}[b >= 0]">{{b}}</b>
		       			<span ng-if="!($index == '6' || $index == '9')">
		       				{{b}}
		       			</span>
		       		</td>
	       		</tr>
