	...
	<div>
	  <form id="dictForm">
        ...
        <p>
            ...
            <input type="text" id="value" name="value" value="${dictVo.value}" class="input-search-text" disabled>
        </p>
        <p>
            <label class="label" id="nameLabel">标签<span style="color: red;">*</span>:</label>
            <input type="text" id="label" name="label" value="${dictVo.label}" class="input-search-text">
        </p>
        <p>
            <label class="label" id="deptLabel">类型<span style="color: red;">*</span>:</label>
            <input type="text" id="type" name="type" value="${dictVo.type}" class="input-search-text" disabled="disabled">
        </p>
<!--         <p> -->
<!--             <label class="label" id="deptLabel">描述:</label> -->
<%--             <input type="text" id="description" name="description" value="${dictVo.description}" class="input-search-text"> --%>
<!--         </p> -->
        <p>
        ...
        <p>
			...
			<textarea rows="5" cols="50" id="description" name="description">${dictVo.description}</textarea>
        </p>
	   </form>  		
	</div>
...
$(document).ready(function(){
    //=========临时添加属性用于disablel禁用时存储数据类型所用==start==========
	var labelVal = $("#label").val();
	var typeVal = $("#type").val();
	if(typeVal == "time_hz_type"){
		$("#value").removeAttr("disabled");
		$("#timeHzType").val("time_hz_type");
	}
	if(labelVal == "time_hz_val"){
		$("#label").attr("disabled","disabled");
		$("#timeHzVal").val("time_hz_val");
	}
	//=========临时添加属性用于disablel禁用时存储数据类型所用==end==========
});
</script>
</body>
</html>