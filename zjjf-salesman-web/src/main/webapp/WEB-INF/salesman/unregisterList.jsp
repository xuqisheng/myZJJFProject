...
<div class="wrap-bd">
	...
	<div class="op-section clearfix">
		<form action="" id="shopForm" method="" class="fl">
			...
			<input class="input-search-text" type="text" id="shopNo" name="shopNo" placeholder="商铺名称/手机号/编号">
			<select name="shopTypeTmp" style="width:150px;height:29px;">
			...
			<input type="button" class="input-search-button" value="关联选中" onclick="bindSpGroup();"/>
		</form>
	</div>
	<div>
...
<script src="${root}/resources/vendor/salesman/js/unregisterList.js"></script>
</body>
</html>