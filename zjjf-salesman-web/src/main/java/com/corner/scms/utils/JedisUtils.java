...
//	private static JedisPool jedisPool = SpringContextHolder.getBean("jedisPool");
	public static final String KEY_PREFIX = PropertiesCacheUtil.getValue("redis.keyPrefix", PropertieNameConts.System);
	...
	public synchronized static JedisPool getInstance() {
		if (jedisPool == null) {
			jedisPool = new JedisPool(new JedisPoolConfig(), PropertiesCacheUtil.getValue("redis.host", PropertieNameConts.System));
		}
		return jedisPool;
	}
...
//			jedis = jedisPool.getResource();
	        ...
	        //PropertiesCacheUtil.getValue("redis.password", PropertieNameConts.System);
	        jedis.auth(PropertiesCacheUtil.getValue("redis.password", PropertieNameConts.System));
