...
import com.corner.scms.dao.CustomerServiceMgMapper;
...
//	CustomerServiceMapper csMapper;
	...
	@Autowired
	CustomerServiceMgMapper CustomerMgMapper;
...
//		ScManager rightUser2 = new ScManager();
//		rightUser2.setId("1ABE24E0DEA54A74A1C86F7D242428A3");
//		rightUser2.setSupplierName("罗湖测试");
//		rightUser2.setPassword("96e79218965eb72c92a549dd5a330112");
//		rightUser2.setMobile("15255108902");
		if (rightUser2 == null) {
...
//		Supplier rightUser = new Supplier();
//		rightUser.setId("1ABE24E0DEA54A74A1C86F7D242428A3");
//		rightUser.setSupplierName("罗湖测试");
//		rightUser.setPassword("96e79218965eb72c92a549dd5a330112");
//		rightUser.setMobile("15255108902");
		...
		if (count == 1) {
			logger.info("用户登陆成功,id:{},手机号：{},名称,{}", rightUser.getId(), rightUser.getMobile(), rightUser.getSupplierName());
			return new ModelMsg(true, "登陆成功");
		} else {
			return new ModelMsg(false, "数据异常");
		}
	...
	public ModelMsg dealKefuSuccessLogin(LoginRo loginRo, HttpServletRequest request, Model model) {
		CustomerService rightUser = CustomerMgMapper.getUserByCustomerServiceCredential(loginRo.getUserName());
		if(null == rightUser){
			return new ModelMsg(false, "帐号信息不存在！");
		}
		SecurityUtils.getSubject().getSession().setAttribute(SessionConfig.USER_SESSION_KEY, rightUser);
		...
		int count = CustomerMgMapper.updateByPrimaryKeySelective(cs);
		if (count == 1) {
	...
	public String getPasswordById(String id) {
		return authorityMapper.selectPasswordById(id);
	}
	//修改供应商密码
	@Override
	public void updateLoginPassword(String id,String newPassword){
		...
		authorityMapper.updateLoginPassword(upPassParm);
	}
