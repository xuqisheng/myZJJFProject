package com.corner.rpc.salesman.startup;
...
public class Bootstrap extends AbstractIdleService  implements ServletContextListener{
    ...
    protected void startUp() throws Exception {
        LOGGER.info("===================zjjf-salesman START BEGIN==========================");
        Long startTime = System.nanoTime();
        context = new ClassPathXmlApplicationContext(new String[]{"config/spring/salesman-context.xml"});
        context.start();
        ...
        LOGGER.info("===================zjjf-salesman START END==========================");
