package com.corner.salesman.commons.dao;
...
import com.corner.salesman.commons.utils.Const;
import com.corner.salesman.commons.utils.CookieUtils;
import com.corner.salesman.commons.utils.Tools;
...
public class Page<T> {
	...
	private int pageSize =  Integer.parseInt(Tools.readTxtFile(Const.PAGE));// 页面大小，设置为“-1”表示不进行分页（分页无效）
