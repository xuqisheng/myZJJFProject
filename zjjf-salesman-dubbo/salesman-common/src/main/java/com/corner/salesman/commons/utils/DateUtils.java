...
public class DateUtils {  
    ...
    public static final String ABBR_DATE_FORMAT = "yyyyMMdd";//简写格式
    public static final String NORMAL_DATE_FORMAT = "yyyy-MM-dd"; //标准格式 
    ...
    public static final String DATETIME_FORMAT_2 = "yyyy年MM月dd日 HH:mm:ss"; 
    public static final String DATETIME_FORMAT_3 = "yyyy-MM-dd"; 
    public static final String DATETIME_FORMAT_4 = "yyyy年MM月dd日"; 
    public static final String DATETIME_FORMAT_5 = "yyyyMMddHHmmssS"; 
    public static final String DATETIME_FORMAT_6 = "yyyyMMdd"; 
    public static final String DATETIME_FORMAT_7 = "MM月dd日 HH:mm"; 
    public static final String DATETIME_FORMAT_8 = "HH:mm:ss"; 
    public static final String DATETIME_FORMAT_9 = "HH:mm"; 
    ...
    public static String getChineseWeekdayNum() {  
        switch (Calendar.getInstance().get(7)) {  
        case 2:  
            return "1";  
        case 3:  
     ...
     * @throws Exception
     */
    public static long getStringToDate(String time,String format) throws Exception{
    ...
    /*public static void main(String[] paramArrayOfString) {  
        try {  
        	 ...
        	 System.err.println(getChineseWeekday());
           // System.out.println(formatDate(addMonths(parseDate("2013-01-06"), 12)));  
        	 
        	 
        	 System.err.println(DateUtils.dateToString(new Date(), DateUtils.HOUR_TIME_FORMAT));
        	 
        	 System.err.println(DateUtils.timestampToDate("1458616455", DateUtils.HOUR_TIME_FORMAT));
        	 System.err.println(DateUtils.timestampToDate("1458616455"));
        } catch (Exception localException) {  
            System.out.println(localException);  
        }  
    } */
    /*public static void main(String[] args) throws Exception {
    	String startTime = "2016-05-06 19:00:00";
    	String endTime = "2016-05-06 19:00:21";
    	String format = "yyyy-MM-dd HH:mm:ss";
		System.err.println(dateDiff(startTime, endTime, format));
		
		System.err.println(dateToString(addDays(new Date(), 1), "yyyy-MM-dd")+" 00:00:00");
	}*/
    
    /*public static void main(String[] args) {
    	System.err.println(dateToString(new Date(), DateUtils.DATETIME_FORMAT_7));
	}*/
}